...
public class Item {
    ...
    public static void l() {
        ...
        //------------------------------------------------------------//
        REGISTRY.a(6000, "argent_ingot", (new Item()).c("argent_ingot").a(CreativeModeTab.l).f("argent_ingot"));
        REGISTRY.a(6001, "cuivre_ingot", (new Item()).c("cuivre_ingot").a(CreativeModeTab.l).f("cuivre_ingot"));
        REGISTRY.a(6002, "cinabre", (new Item()).c("cinabre").a(CreativeModeTab.l).f("cinabre"));
        REGISTRY.a(6003, "bournonite_ingot", (new Item()).c("bournonite_ingot").a(CreativeModeTab.l).f("bournonite_ingot"));
        REGISTRY.a(6004, "azurite", (new Item()).c("azurite").a(CreativeModeTab.l).f("azurite"));
        //------------------------------------------------------------//
