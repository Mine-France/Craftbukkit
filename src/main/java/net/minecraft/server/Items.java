...
public class Items {
    ...
    //------------------------------------------------------------//
    public static final Item ARGENT_INGOT = (Item) Item.REGISTRY.a("argent_ingot");
    public static final Item CUIVRE_INGOT = (Item) Item.REGISTRY.a("cuivre_ingot");
    public static final Item CINABRE = (Item) Item.REGISTRY.a("cinabre");
    public static final Item BOURNONITE_INGOT = (Item) Item.REGISTRY.a("bournonite_ingot");
    public static final Item AZURITE = (Item) Item.REGISTRY.a("azurite");
    //------------------------------------------------------------//
