...
public class Block {
    ...
    public static void p() {
        ...
        //------------------------------------------------------------//
        REGISTRY.a(4000, "argent_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("argent_ore").d("argent_ore"));
        REGISTRY.a(4001, "argent_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("argent_block").d("argent_block"));
        REGISTRY.a(4002, "cuivre_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("cuivre_ore").d("cuivre_ore"));
        REGISTRY.a(4003, "cuivre_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("cuivre_block").d("cuivre_block"));
        REGISTRY.a(4004, "cinabre_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("cinabre_ore").d("cinabre_ore"));
        REGISTRY.a(4005, "cinabre_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("cinabre_block").d("cinabre_block"));
        REGISTRY.a(4006, "bournonite_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("bournonite_ore").d("bournonite_ore"));
        REGISTRY.a(4007, "bournonite_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("bournonite_block").d("bournonite_block"));
        REGISTRY.a(4008, "azurite_ore", (new BlockOre()).c(3.0F).b(5.0F).a(i).c("azurite_ore").d("azurite_ore"));
        REGISTRY.a(4009, "azurite_block", (new BlockOreBlock(MaterialMapColor.G)).c(5.0F).b(10.0F).a(j).c("azurite_block").d("azurite_block"));
        //------------------------------------------------------------//
